...
export default class RequestWatcher {
  constructor (options = {}) {
    this._options = Object.assign({
      reconnectTimeout: 300000, // 5s
      pollTimeout: 300000, // 5s
      pingTimeout: 300000 // 30s,
    }, options)
    this._requests = []
  ...
  watch (uri) {
    // console.log(":::::::::Inside Request Watcher:::::::::::");
    const request = {
    ...
    const watcher = {
      ...
      start: function start () {
        // console.log(":::::::::Request Watcher 1111:::::::::::");
        if (this._wsReady) {
          this._sendMessage('start', request.id, request.uri)
        } else {
          // console.log(":::::::::Request Watcher 2222:::::::::::");
        ...
        // console.log(":::::::::Request Watcher 3333:::::::::::");
        return watcher
      }.bind(this),
      stop: function stop () {
    ...
    // console.log(":::::::::Returning Request Watcher:::::::::::");
    return watcher
  }
}
